...
public class FileParser {
	...
	public StrategyHolder parsePreflopStrategy(String content) {
		...
		preflopStrategy.addIndividualCards(individualCardStrategy);
	...
	private List<IndividualCardStrategy> createOffSuitedBundleTypeCards(Card highCard, Card lowCard, double occurance) {
		...
		IndividualCardHand dc = new IndividualCardHand(highCard, CardColor.DIAMONDS, lowCard, CardColor.SPADES);
	...
	private List<IndividualCardStrategy> createPairBundleTypeCards(Card pair, double occurance) {
		...
		IndividualCardHand cd = new IndividualCardHand(pair, CardColor.CLUBS, pair, CardColor.DIAMONDS);
		IndividualCardHand cs = new IndividualCardHand(pair, CardColor.CLUBS, pair, CardColor.SPADES);
		IndividualCardHand ch = new IndividualCardHand(pair, CardColor.CLUBS, pair, CardColor.HEARTS);
		IndividualCardHand ds = new IndividualCardHand(pair, CardColor.DIAMONDS, pair, CardColor.SPADES);
		IndividualCardHand dh = new IndividualCardHand(pair, CardColor.DIAMONDS, pair, CardColor.HEARTS);
