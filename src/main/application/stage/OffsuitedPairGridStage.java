...
public class OffsuitedPairGridStage extends AbstractCardDetailStage {
	...
	protected void clearCardGrid() {
		...
		gridListToClean.add((GridPane)this.getStage().getScene().lookup("#ds"));
		gridListToClean.add((GridPane)this.getStage().getScene().lookup("#dh"));
		gridListToClean.add((GridPane)this.getStage().getScene().lookup("#dc"));
		gridListToClean.add((GridPane)this.getStage().getScene().lookup("#ch"));
		...
		gridListToClean.add((GridPane)this.getStage().getScene().lookup("#cs"));
		gridListToClean.add((GridPane)this.getStage().getScene().lookup("#hs"));
		...
		gridListToClean.add((GridPane)this.getStage().getScene().lookup("#cd"));
